  ...
  return (
    <AdminLayout>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2.5rem' }}>
        <Link
          href="/admin/news"
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '2.5rem', height: '2.5rem', borderRadius: '0.75rem', background: '#f1f5f9', color: '#64748b', textDecoration: 'none', transition: 'all 0.2s', flexShrink: 0 }}
        ...
        <div>
          ...
          <p style={{ color: '#64748b', marginTop: '0.25rem', fontSize: '0.875rem' }}>
            Добавьте новую запись в ленту новостей
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSave} style={{ maxWidth: '52rem' }}>
        <div style={{ background: 'white', borderRadius: '1.5rem', border: '1px solid #f1f5f9', padding: '2rem', boxShadow: '0 4px 24px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              ...
              >
                ...
                {uploading ? '...' : 'Загрузить'}
                <input type="file" className="hidden" onChange={handleDirectUpload} accept="image/*" disabled={uploading} />
              </label>
            </div>
            <p style={{ fontSize: '0.65rem', color: '#94a3b8', marginTop: '0.375rem', paddingLeft: '0.5rem' }}>
              Загрузите фото с компьютера или выberite из медиатеки
            </p>
          </div>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'flex-end', paddingTop: '0.5rem', borderTop: '1px solid #f1f5f9' }}>
            <Link
              href="/admin/news"
              style={{ padding: '0.75rem 1.5rem', borderRadius: '0.875rem', background: '#f1f5f9', color: '#64748b', fontWeight: 700, fontSize: '0.875rem', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', transition: 'all 0.2s' }}
              onMouseEnter={e => e.currentTarget.style.background = '#e2e8f0'}
              onMouseLeave={e => e.currentTarget.style.background = '#f1f5f9'}
            >
              Отмена
            ...
            <button
              type="submit"
              disabled={saving}
              style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.75rem 1.75rem', background: 'linear-gradient(135deg, #3b82f6, #2563eb)', color: 'white', border: 'none', borderRadius: '0.875rem', fontWeight: 700, fontSize: '0.875rem', cursor: saving ? 'not-allowed' : 'pointer', opacity: saving ? 0.7 : 1, boxShadow: '0 4px 16px rgba(59,130,246,0.35)', transition: 'all 0.2s', fontFamily: 'inherit' }}
            >
